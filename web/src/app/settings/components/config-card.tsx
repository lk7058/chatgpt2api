...
import { CalendarCheck, Cloud, Coins, Globe, ImageIcon, LoaderCircle, PlugZap, RefreshCw, Save, ShieldAlert } from "lucide-react";
...
export function ConfigCard() {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* 基础信息 */}
      <ConfigSection icon={<Globe className="size-4 text-stone-600" />} title="基础信息">
      ...
      {/* 注册与签到 */}
      <ConfigSection icon={<CalendarCheck className="size-4 text-stone-600" />} title="注册与签到">
      ...
      {/* 代理与网络 */}
      <ConfigSection icon={<PlugZap className="size-4 text-stone-600" />} title="代理与网络">
        <div className="space-y-2">
      ...
      {/* 图片生成 */}
      <ConfigSection icon={<ImageIcon className="size-4 text-stone-600" />} title="图片生成">
        <div className="space-y-2">
      ...
      {/* 图片存储（WebDAV） */}
      <ConfigSection icon={<Cloud className="size-4 text-stone-600" />} title="图片存储（WebDAV）">
      ...
      {/* 账号维护 */}
      <ConfigSection icon={<RefreshCw className="size-4 text-stone-600" />} title="账号维护">
        <div className="space-y-2">
      ...
      {/* 内容审核 */}
      <ConfigSection icon={<ShieldAlert className="size-4 text-stone-600" />} title="内容审核">
        <div className="space-y-2 md:col-span-2">
      ...
      {/* 模型额度与日志 */}
      <ConfigSection icon={<Coins className="size-4 text-stone-600" />} title="模型额度与日志">
        <div className="space-y-2 md:col-span-2">
      ...
      {/* 保存 */}
      <div className="sticky bottom-3 z-20 flex justify-end rounded-xl border border-white/80 bg-white/90 px-4 py-3 shadow-sm backdrop-blur">
        <Button
